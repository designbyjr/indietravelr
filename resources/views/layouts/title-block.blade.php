<div class="title-bar">
		<div class="title-bar-content">
			...
			<!-- <div> -->
				<ul class="nav-items-horizontal">
					...
					<li class="nav-item nav-more">
						More<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="nav-expand-arrow"><path d="M12 21l-12-18h24z"></path>
					</svg></li>
					<li class="nav-item nav-menu">
							<img src="menu.svg" alt="dropdown menu">
					</li>
				</ul>
			...
			<div class="nav-btns">
				...
				<button class="book-now-btn">SIGN UP</button>
			</div>
		</div>
	</div>
